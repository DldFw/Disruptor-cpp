...
const std::shared_ptr< ManualResetEvent >& LongArrayEventHandler::signal() const
{
	return m_signal;
}
...
void LongArrayEventHandler::reset(const std::shared_ptr< ManualResetEvent >& signal, std::int64_t expectedCount)
{
	m_value->value = 0L;
	m_signal = signal;
