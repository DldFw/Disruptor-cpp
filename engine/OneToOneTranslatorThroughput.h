 ...
 *
 */
class OneToOneTranslatorThroughput : public IThroughput
{
	class Translator;
...
class OneToOneTranslatorThroughput::Translator : public IEventTranslatorVararg< ValueEvent, MutableLong >
{
	public:
