...
OneToThreePipelineSequencedThroughput::OneToThreePipelineSequencedThroughput()
{
...
std::int64_t OneToThreePipelineSequencedThroughput::run(Stopwatch& stopwatch)
{
	...
	PerfUtil::failIfNot(m_expectedResult, m_stepThreeFunctionHandler->stepThreeCounter());

	return m_iterations;
}

std::int32_t OneToThreePipelineSequencedThroughput::requiredProcessorCount() const
{
	return 4;
}
