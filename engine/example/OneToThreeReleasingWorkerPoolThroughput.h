...
class OneToThreeReleasingWorkerPoolThroughput : public IThroughput
{
	class EventCountingAndReleasingWorkHandler;

	public:
	OneToThreeReleasingWorkerPoolThroughput();
...
class OneToThreeReleasingWorkerPoolThroughput::EventCountingAndReleasingWorkHandler : public IWorkHandler< ValueEvent >, public IEventReleaseAware
{
	public:
