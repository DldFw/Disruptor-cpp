 ...
 * 
 */
class ThreeToOneSequencedThroughput : public IThroughput
{
	using ValuePublisher = std::function< void(const std::shared_ptr< CountdownEvent >&, const std::shared_ptr< RingBuffer< ValueEvent > >&, std::int64_t) >;

	public:
	ThreeToOneSequencedThroughput();
