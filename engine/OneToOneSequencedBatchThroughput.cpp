...
OneToOneSequencedBatchThroughput::OneToOneSequencedBatchThroughput()
{
...
std::int64_t OneToOneSequencedBatchThroughput::run(Stopwatch& stopwatch)
{
...
std::int32_t OneToOneSequencedBatchThroughput::requiredProcessorCount() const
{
	return 2;
}
